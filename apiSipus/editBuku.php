...
$query = mysqli_query($koneksi,"update buku set cover='$cover',judul='$judul',pengarang='$pengarang',penerbit='$penerbit',kategori='$kategori',lokasi='$lokasi',ketersediaan='$ketersediaan' where kd_buku='$kd_buku'");
}
